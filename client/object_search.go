...
//
// The result is sorted lexicographically by the first attribute and then by
// object ID. System attributes can be included using special aliases
// like [object.FilterPayloadSize]. If attributes are specified, the first
// filter must correspond to the first attribute. The maximum number of filters
// is 8. The maximum number of attributes is 8. Neither filters nor attributes
// can contain [object.FilterContainerID] or [object.FilterID].
// Filters using [object.FilterRoot] and [object.FilterPhysical] properties must
// have a zero value and matcher.
//
