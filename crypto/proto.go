...
type SignedRequest[BODY proto.Message] interface {
	GetBody() BODY
...
type SignedResponse[BODY proto.Message] interface {
	GetBody() BODY
...
func SignRequestWithBuffer[BODY proto.Message](signer Signer, r SignedRequest[BODY], buf []byte) (*session.RequestVerificationHeader, error) {
	var ln int
	var err error
...
//
// Buffer is optional and free after the call.
func VerifyRequestWithBuffer[BODY proto.Message](r SignedRequest[BODY], buf []byte) error {
	v := r.GetVerifyHeader()
	if v == nil {
...
//
// Buffer is optional and free after the call.
func SignResponseWithBuffer[BODY proto.Message](signer Signer, r SignedResponse[BODY], buf []byte) (*session.ResponseVerificationHeader, error) {
	var ln int
	var err error
	vhOriginal := r.GetVerifyHeader()
...
//
// Buffer is optional and free after the call.
func VerifyResponseWithBuffer[BODY proto.Message](r SignedResponse[BODY], buf []byte) error {
	v := r.GetVerifyHeader()
	if v == nil {
		return errMissingVerifyHdr
	}
