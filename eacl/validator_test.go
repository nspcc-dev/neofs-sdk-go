...
func TestNumericRules(t *testing.T) {
	for _, tc := range []struct {
		...
		{MatchNumGT, "-1", "0", true},
		{MatchNumGT, "0", "1", true},
		{MatchNumGT, "111111111111111111111111111110", "111111111111111111111111111111", true}, // more than 64-bit
