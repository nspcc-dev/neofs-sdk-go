...
var validSignedBearerToken = []byte{
	10, 153, 2, 10, 4, 8, 2, 16, 18, 18, 34, 10, 32, 243, 245, 75, 198, 48, 107, 141, 121, 255, 49, 51, 168, 21, 254, 62,
	...
	3, 26, 11, 107, 101, 121, 95, 49, 50, 57, 56, 52, 51, 50, 34, 11, 118, 97, 108, 95, 56, 50, 52, 51, 50, 53, 56, 34,
	6, 8, 196, 203, 182, 201, 2, 34, 81, 18, 25, 53, 192, 107, 60, 173, 127, 3, 69, 236, 239, 37, 107, 173, 167, 143,
	161, 20, 113, 133, 199, 150, 139, 182, 171, 184, 18, 25, 53, 14, 64, 221, 23, 249, 186, 133, 93, 139, 98, 131, 163,
	110, 134, 7, 6, 164, 198, 136, 124, 32, 202, 88, 107, 18, 25, 53, 85, 27, 45, 129, 140, 18, 120, 223, 85, 88, 64,
	164, 131, 242, 184, 191, 237, 33, 233, 187, 82, 171, 117, 111, 18, 27, 10, 25, 53, 147, 14, 186, 66, 195, 247, 51,
	14, 249, 145, 102, 233, 115, 142, 143, 145, 26, 229, 252, 61, 36, 160, 242, 243, 26, 18, 8, 238, 215, 164, 15, 16,
	183, 189, 151, 204, 221, 2, 24, 190, 132, 217, 192, 4, 34, 27, 10, 25, 53, 51, 5, 166, 111, 29, 20, 101, 192, 165,
	28, 167, 57, 160, 82, 80, 41, 203, 20, 254, 30, 138, 195, 17, 92,
}

// corresponds to validBearerToken.
var validBinBearerToken = []byte{
	10, 234, 2, 10, 153, 2, 10, 4, 8, 2, 16, 18, 18, 34, 10, 32, 243, 245, 75, 198, 48, 107, 141, 121, 255, 49, 51, 168,
	21, 254, 62, 66, 6, 147, 43, 35, 99, 242, 163, 20, 26, 30, 147, 240, 79, 114, 252, 227, 26, 57, 8, 204, 253, 149, 6,
	16, 182, 183, 219, 2, 26, 37, 8, 241, 159, 147, 2, 16, 137, 249, 57, 26, 12, 107, 101, 121, 95, 53, 52, 48, 57, 51,
	54, 52, 51, 34, 12, 118, 97, 108, 95, 51, 52, 56, 49, 49, 48, 52, 48, 34, 6, 8, 196, 203, 182, 201, 2, 26, 177, 1,
	8, 162, 216, 128, 45, 16, 235, 218, 232, 20, 26, 37, 8, 241, 159, 147, 2, 16, 137, 249, 57, 26, 12, 107, 101, 121,
	95, 53, 52, 48, 57, 51, 54, 52, 51, 34, 12, 118, 97, 108, 95, 51, 52, 56, 49, 49, 48, 52, 48, 26, 35, 8, 200, 202,
	35, 16, 228, 149, 204, 3, 26, 11, 107, 101, 121, 95, 49, 50, 57, 56, 52, 51, 50, 34, 11, 118, 97, 108, 95, 56, 50,
	52, 51, 50, 53, 56, 34, 6, 8, 196, 203, 182, 201, 2, 34, 81, 18, 25, 53, 192, 107, 60, 173, 127, 3, 69, 236, 239,
	37, 107, 173, 167, 143, 161, 20, 113, 133, 199, 150, 139, 182, 171, 184, 18, 25, 53, 14, 64, 221, 23, 249, 186, 133,
	93, 139, 98, 131, 163, 110, 134, 7, 6, 164, 198, 136, 124, 32, 202, 88, 107, 18, 25, 53, 85, 27, 45, 129, 140, 18,
	120, 223, 85, 88, 64, 164, 131, 242, 184, 191, 237, 33, 233, 187, 82, 171, 117, 111, 18, 27, 10, 25, 53, 147, 14,
	186, 66, 195, 247, 51, 14, 249, 145, 102, 233, 115, 142, 143, 145, 26, 229, 252, 61, 36, 160, 242, 243, 26, 18, 8,
	238, 215, 164, 15, 16, 183, 189, 151, 204, 221, 2, 24, 190, 132, 217, 192, 4, 34, 27, 10, 25, 53, 51, 5, 166, 111,
	29, 20, 101, 192, 165, 28, 167, 57, 160, 82, 80, 41, 203, 20, 254, 30, 138, 195, 17, 92, 18, 56, 10, 33, 3, 202,
	217, 142, 98, 209, 190, 188, 145, 123, 174, 21, 173, 239, 239, 245, 67, 148, 205, 119, 58, 223, 219, 209, 220, 113,
	215, 134, 228, 101, 249, 34, 218, 18, 13, 97, 110, 121, 95, 115, 105, 103, 110, 97, 116, 117, 114, 101, 24, 236,
	236, 175, 192, 4,
}
...
func TestToken_Sign(t *testing.T) {
	...
	require.Equal(t, []byte{
		41, 62, 195, 224, 174, 69, 16, 44, 61, 232, 189, 25, 229, 94, 157, 0, 235, 27, 10, 16, 183, 198, 172, 46, 146,
		36, 240, 229, 166, 105, 208, 162, 46, 96, 253, 56, 22, 8, 209, 227, 3, 204, 166, 74, 101, 252, 112, 182, 152,
		130, 170, 70, 57, 219, 21, 230, 154, 2, 166, 234, 74, 242, 247, 122}, sig)
...
func TestToken_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{
			4, 93, 213, 6, 101, 6, 244, 31, 0, 167, 28, 114, 98, 241, 164, 17, 29, 151, 231, 67, 161, 71, 206, 245, 73,
			27, 156, 202, 155, 10, 39, 63, 253, 53, 114, 201, 64, 77, 183, 212, 252, 2, 207, 22, 140, 66, 227, 132, 10,
			235, 159, 54, 218, 22, 212, 147, 34, 6, 56, 12, 113, 162, 196, 80, 113,
		}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{
			99, 107, 51, 42, 162, 18, 186, 203, 214, 43, 108, 200, 187, 214, 222, 38, 48, 148, 12, 38, 171, 155, 229,
			232, 15, 216, 43, 129, 11, 152, 160, 69, 64, 228, 211, 84, 90, 29, 222, 117, 228, 157, 99, 225, 142, 55,
			222, 124, 194, 62, 212, 3, 53, 228, 129, 50, 65, 56, 198, 34, 252, 66, 24, 188,
		}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{
			136, 48, 17, 125, 177, 109, 179, 129, 112, 51, 236, 39, 42, 41, 202, 134, 196, 131, 144, 240, 201, 119, 26,
			16, 43, 125, 165, 225, 156, 236, 87, 162, 211, 69, 37, 243, 108, 50, 38, 125, 58, 59, 253, 136, 94, 48, 231,
			8, 190, 116, 70, 184, 226, 149, 48, 236, 137, 19, 125, 77, 11, 11, 233, 120, 9, 15, 23, 183, 193, 65, 165,
			164, 216, 74, 205, 215, 166, 166, 80, 227,
		}},
	} {
...
func TestToken_ProtoMessage(t *testing.T) {
	...
	require.EqualValues(t, 18, e.GetVersion().GetMinor())
