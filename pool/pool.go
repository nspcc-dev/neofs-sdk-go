...
type sdkClientInterface interface {
	...
	SearchObjects(ctx context.Context, containerID cid.ID, count uint32, signer neofscrypto.Signer, opts sdkClient.SearchObjectsOptions) ([]sdkClient.SearchResultItem, string, error)
