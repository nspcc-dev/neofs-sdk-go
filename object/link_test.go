...
func TestLink_Unmarshal(t *testing.T) {
	t.Run("invalid", func(t *testing.T) {
		...
		for _, tc := range []struct {
			...
			{name: "members/empty value", err: "invalid child #1: invalid ID: invalid length 0",
			...
			{name: "members/undersize", err: "invalid child #1: invalid ID: invalid length 31",
				b: []byte{10, 36, 10, 34, 10, 32, 178, 74, 58, 219, 46, 3, 110, 125, 220, 81, 238, 35, 27, 6, 228, 193, 190,
			...
			{name: "members/oversize", err: "invalid child #1: invalid ID: invalid length 33",
				b: []byte{10, 36, 10, 34, 10, 32, 178, 74, 58, 219, 46, 3, 110, 125, 220, 81, 238, 35, 27, 6, 228, 193, 190,
