...
func TestObject_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{4, 129, 112, 91, 83, 237, 9, 191, 82, 66, 9, 19, 7, 149, 158, 220, 51,
			150, 95, 246, 250, 129, 93, 222, 242, 5, 116, 180, 45, 198, 22, 4, 179, 207, 229, 160, 34, 227, 212, 148, 122, 96,
			186, 164, 1, 231, 86, 34, 71, 205, 195, 38, 159, 77, 183, 131, 16, 74, 148, 246, 122, 21, 107, 17, 21}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{142, 10, 228, 79, 11, 239, 176, 41, 49, 94, 236, 218, 73,
			255, 40, 55, 226, 9, 53, 42, 123, 29, 36, 173, 249, 93, 191, 208, 163, 84, 22, 42, 107, 190, 140, 179, 61, 78, 129,
			28, 72, 189, 104, 175, 7, 106, 158, 231, 103, 1, 105, 182, 229, 45, 223, 97, 166, 166, 163, 80, 229, 5, 77, 105}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{138, 102, 104, 13, 168, 45, 124, 195, 235, 21, 115, 232, 13, 248,
			37, 218, 71, 6, 21, 99, 165, 187, 212, 198, 26, 63, 125, 5, 246, 32, 24, 130, 34, 120, 114, 11, 219, 229, 200, 123,
			123, 116, 223, 142, 96, 181, 149, 170, 222, 223, 128, 137, 232, 84, 94, 53, 50, 189, 77, 139, 126, 78, 252, 168,
			194, 85, 62, 239, 34, 253, 159, 245, 26, 164, 154, 215, 56, 192, 45, 3}},
	} {
