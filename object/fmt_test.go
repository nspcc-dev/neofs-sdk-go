...
func TestObject_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{4, 157, 208, 48, 92, 64, 50, 239, 162, 224, 125, 240, 39, 15, 101, 98, 159,
			5, 80, 32, 234, 246, 211, 110, 50, 46, 202, 175, 185, 141, 163, 5, 7, 138, 179, 164, 161, 50, 229, 108, 209, 222, 177, 58,
			134, 56, 127, 102, 112, 223, 22, 152, 245, 14, 91, 146, 144, 16, 171, 155, 241, 3, 151, 155, 58}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{114, 202, 254, 142, 34, 127, 224, 11, 6, 105, 200, 235, 154,
			191, 7, 168, 209, 236, 155, 34, 107, 134, 13, 44, 53, 142, 89, 191, 255, 45, 38, 102, 226, 7, 231, 148, 57, 175, 237, 91,
			4, 34, 194, 126, 157, 140, 14, 93, 159, 7, 8, 207, 165, 139, 44, 203, 114, 110, 150, 195, 12, 61, 153, 29}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{15, 138, 149, 242, 96, 138, 254, 168, 236, 255, 138, 156, 26, 169,
			55, 31, 140, 151, 99, 31, 65, 69, 170, 103, 109, 245, 87, 229, 27, 21, 200, 86, 100, 88, 191, 106, 135, 84, 34, 198, 105,
			247, 195, 74, 194, 50, 2, 204, 180, 187, 2, 113, 247, 67, 107, 100, 4, 3, 135, 50, 227, 227, 74, 224, 82, 232, 213,
			210, 119, 73, 235, 106, 131, 155, 138, 76, 85, 96, 112, 250}},
	} {
