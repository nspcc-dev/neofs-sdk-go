...
func TestObject_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{4, 98, 17, 183, 253, 156, 15, 244, 150, 89, 215, 89, 153, 145,
			66, 79, 200, 24, 127, 196, 214, 200, 70, 41, 85, 39, 8, 116, 249, 38, 200, 29, 123, 141, 161, 21, 185, 201,
			97, 74, 39, 79, 61, 200, 215, 190, 196, 52, 14, 251, 152, 238, 68, 157, 119, 32, 69, 101, 199, 63, 248, 205,
			228, 39, 19}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{218, 68, 142, 165, 16, 1, 178, 81, 59, 211, 231,
			199, 147, 170, 90, 225, 21, 149, 208, 99, 52, 125, 41, 124, 229, 43, 6, 44, 167, 83, 106, 22, 68, 179, 223,
			4, 208, 91, 245, 123, 22, 250, 26, 162, 18, 6, 145, 245, 17, 89, 108, 255, 72, 15, 61, 114, 112, 150, 245,
			240, 139, 7, 199, 77}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{213, 36, 96, 222, 234, 27, 98, 118, 47, 95, 48, 175, 17,
			254, 96, 171, 141, 71, 79, 154, 36, 30, 226, 184, 31, 81, 159, 110, 8, 165, 20, 187, 207, 242, 153, 230, 23,
			159, 245, 75, 201, 188, 82, 29, 129, 182, 68, 249, 142, 185, 19, 35, 63, 14, 163, 117, 227, 150, 5, 70, 192,
			116, 231, 13, 2, 110, 231, 57, 205, 179, 220, 149, 106, 121, 219, 72, 77, 190, 125, 1}},
	} {
