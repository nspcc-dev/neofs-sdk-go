...
func TestObject_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{4, 41, 24, 176, 223, 129, 182, 34, 57, 74, 93, 153, 139, 47, 1, 238,
			141, 43, 24, 245, 31, 195, 200, 174, 81, 12, 251, 0, 13, 94, 247, 193, 214, 34, 36, 204, 1, 76, 254, 167, 215,
			55, 177, 98, 98, 62, 82, 113, 210, 46, 128, 29, 103, 117, 95, 139, 197, 8, 65, 83, 138, 19, 132, 31, 69}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{227, 147, 234, 230, 177, 229, 232, 39, 190, 127, 7, 15,
			142, 90, 221, 136, 48, 10, 249, 205, 156, 223, 71, 46, 254, 47, 14, 104, 42, 37, 111, 52, 65, 166, 246, 68, 23, 71,
			183, 224, 64, 33, 64, 87, 10, 227, 110, 122, 239, 184, 86, 137, 209, 113, 37, 27, 63, 159, 183, 29, 160, 236, 47, 235}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{19, 187, 246, 148, 43, 18, 38, 38, 21, 4, 191, 25, 156, 255, 48,
			151, 245, 28, 185, 243, 32, 171, 110, 168, 33, 101, 171, 62, 99, 117, 69, 129, 148, 77, 82, 27, 100, 90, 183, 242,
			155, 134, 118, 0, 24, 33, 18, 227, 11, 153, 187, 113, 63, 219, 54, 241, 146, 236, 23, 97, 52, 97, 238, 247, 20, 197,
			95, 67, 76, 137, 84, 80, 97, 105, 231, 127, 96, 34, 83, 229}},
	} {
