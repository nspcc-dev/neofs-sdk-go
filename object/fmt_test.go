...
func TestObject_VerifySignature(t *testing.T) {
	...
	for i, tc := range []struct {
		...
		{scheme: neofscrypto.ECDSA_SHA512, sig: []byte{4, 156, 100, 103, 235, 44, 123, 234, 232, 241, 132, 162, 205, 246, 171,
			75, 177, 159, 218, 154, 10, 113, 71, 215, 58, 170, 28, 33, 111, 42, 27, 155, 179, 182, 85, 162, 37, 248, 139, 168,
			199, 9, 251, 234, 79, 150, 140, 33, 43, 15, 131, 155, 166, 219, 85, 56, 10, 2, 229, 20, 130, 58, 219, 221, 182}},
		{scheme: neofscrypto.ECDSA_DETERMINISTIC_SHA256, sig: []byte{72, 121, 140, 248, 195, 179, 178, 99, 3, 78, 187, 211, 69,
			16, 212, 131, 108, 108, 98, 23, 211, 75, 67, 61, 50, 164, 114, 243, 130, 123, 210, 201, 138, 115, 208, 87, 25, 2, 232,
			76, 66, 248, 207, 1, 102, 222, 204, 87, 179, 1, 131, 6, 211, 15, 136, 32, 140, 255, 100, 55, 224, 255, 155, 7}},
		{scheme: neofscrypto.ECDSA_WALLETCONNECT, sig: []byte{7, 221, 33, 184, 161, 238, 161, 70, 122, 49, 226, 235, 229, 82, 82,
			114, 226, 237, 135, 104, 101, 218, 170, 164, 188, 118, 65, 48, 62, 201, 44, 2, 66, 222, 248, 2, 89, 244, 173, 146, 2,
			182, 163, 138, 221, 32, 54, 129, 176, 176, 130, 109, 230, 70, 168, 216, 196, 205, 179, 95, 228, 77, 144, 155,
			254, 207, 166, 52, 47, 155, 29, 200, 189, 241, 146, 245, 128, 246, 204, 59}},
	} {
