...
var file_proto_container_types_proto_goTypes = []interface{}{
...
func file_proto_container_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_container_types_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_container_types_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
