...
const file_proto_container_service_proto_rawDesc = "" +
	...
	"\x0ebody_signature\x18\x02 \x01(\v2\x19.neo.fs.v2.refs.SignatureR\rbodySignature\x1a\xb6\x03\n" +
	"\x04Body\x12X\n" +
	"\n" +
	...
	"\x10session_token_v1\x18\x04 \x01(\v2\x1f.neo.fs.v2.session.SessionTokenR\x0esessionTokenV1\x1a\x80\x01\n" +
	"\n" +
	"Parameters\x12>\n" +
	...
	"\x05value\x18\x03 \x01(\tR\x05value\"\xd6\x01\n" +
	...
	"\x04Body\x120\n" +
	"\x06status\x18\x01 \x01(\v2\x18.neo.fs.v2.status.StatusR\x06status\"\xc5\x04\n" +
	"\x16RemoveAttributeRequest\x12D\n" +
	"\x04body\x18\x01 \x01(\v20.neo.fs.v2.container.RemoveAttributeRequest.BodyR\x04body\x12@\n" +
	"\x0ebody_signature\x18\x02 \x01(\v2\x19.neo.fs.v2.refs.SignatureR\rbodySignature\x1a\xa2\x03\n" +
	"\x04Body\x12[\n" +
	"\n" +
	...
	"\tsignature\x18\x02 \x01(\v2 .neo.fs.v2.refs.SignatureRFC6979R\tsignature\x12F\n" +
	"\rsession_token\x18\x03 \x01(\v2!.neo.fs.v2.session.SessionTokenV2R\fsessionToken\x12I\n" +
	"\x10session_token_v1\x18\x04 \x01(\v2\x1f.neo.fs.v2.session.SessionTokenR\x0esessionTokenV1\x1aj\n" +
	"\n" +
	"Parameters\x12>\n" +
	"\fcontainer_id\x18\x01 \x01(\v2\x1b.neo.fs.v2.refs.ContainerIDR\vcontainerId\x12\x1c\n" +
	"\tattribute\x18\x02 \x01(\tR\tattribute\"\xdc\x01\n" +
