...
type SessionTokenV2 struct {
	...
	// Delegation cannot be wider than the previous token's lifetime and contexts.
...
const file_proto_session_types_proto_rawDesc = "" +
	...
	"\x05verbs\x18\x03 \x03(\x0e2\x17.neo.fs.v2.session.VerbR\x05verbs\"\xf8\x03\n" +
	...
	"\x06origin\x18\x03 \x01(\v2!.neo.fs.v2.session.SessionTokenV2R\x06origin\x1a\xb5\x02\n" +
	"\x04Body\x12\x18\n" +
...
var file_proto_session_types_proto_depIdxs = []int32{
	...
	11, // 37: neo.fs.v2.session.SessionTokenV2.Body.issuer:type_name -> neo.fs.v2.session.Target
