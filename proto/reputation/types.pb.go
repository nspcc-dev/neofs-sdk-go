...
var file_proto_reputation_types_proto_rawDesc = []byte{
	...
	0x72, 0x75, 0x73, 0x74, 0x52, 0x05, 0x74, 0x72, 0x75, 0x73, 0x74, 0x42, 0x55, 0x5a, 0x32, 0x67,
	...
	0x6e, 0xaa, 0x02, 0x1e, 0x4e, 0x65, 0x6f, 0x2e, 0x46, 0x69, 0x6c, 0x65, 0x53, 0x74, 0x6f, 0x72,
	0x61, 0x67, 0x65, 0x2e, 0x41, 0x50, 0x49, 0x2e, 0x52, 0x65, 0x70, 0x75, 0x74, 0x61, 0x74, 0x69,
...
func file_proto_reputation_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_reputation_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*PeerID); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_reputation_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Trust); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_reputation_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_proto_reputation_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_reputation_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
