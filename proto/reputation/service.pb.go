...
var file_proto_reputation_service_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x75, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x41, 0x6e, 0x6e, 0x6f, 0x75, 0x6e,
	0x63, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x74, 0x65, 0x52, 0x65,
	0x73, 0x75, 0x6c, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x60, 0x5a, 0x3d,
	...
	0x6f, 0x6e, 0x3b, 0x72, 0x65, 0x70, 0x75, 0x74, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0xaa, 0x02, 0x1e,
...
var (
	...
	file_proto_reputation_service_proto_rawDescData = file_proto_reputation_service_proto_rawDesc
)

func file_proto_reputation_service_proto_rawDescGZIP() []byte {
	file_proto_reputation_service_proto_rawDescOnce.Do(func() {
		file_proto_reputation_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_reputation_service_proto_rawDescData)
	})
...
var file_proto_reputation_service_proto_goTypes = []interface{}{
...
func file_proto_reputation_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_reputation_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_reputation_service_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_reputation_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_proto_reputation_service_proto_rawDesc = nil
