...
type Signature struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Public key used for signing. Content depends on `scheme`, for ECDSA
	// schemes it's 33-byte compressed 256r1 ECDSA key, for N3 scheme it's a NeoVM
...
type SignatureRFC6979 struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Public key used for signing. See Signature for details.
	Key []byte `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
