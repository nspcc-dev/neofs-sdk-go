...
func file_proto_object_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_object_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_proto_object_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Header); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_object_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Object); i {
			case 0:
				return &v.state
			case 1:
		...
		file_proto_object_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_proto_object_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_proto_object_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
