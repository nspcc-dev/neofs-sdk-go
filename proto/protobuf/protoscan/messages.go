...
var (
	...
	TokenLifetimeScheme = newSimpleFieldsScheme(
		newSimpleField(protosession.FieldTokenLifetimeExp, "exp", FieldTypeUint64),
		newSimpleField(protosession.FieldTokenLifetimeNbf, "nbf", FieldTypeUint64),
		newSimpleField(protosession.FieldTokenLifetimeIat, "iat", FieldTypeUint64),
	)
)
...
// IDs.
var (
	ContainerIDScheme = newIDScheme(BinaryFieldKindSHA256)
	ObjectIDScheme    = newIDScheme(BinaryFieldKindSHA256)
	UserIDScheme      = newIDScheme(BinaryFieldKindNeo3Address)
)
...
// Session V1.
var (
	SessionV1ContextScheme = MessageScheme{
		Fields: map[protowire.Number]MessageField{
...
// Object.
var (
	ObjectAttributeScheme = newSimpleFieldsScheme(
		newSimpleField(protoobject.FieldAttributeKey, "key", FieldTypeString),
		newSimpleField(protoobject.FieldAttributeValue, "value", FieldTypeString),
	)
	...
	ObjectHeaderScheme = MessageScheme{
		...
		NestedMessageFields: map[protowire.Number]MessageScheme{
			...
			protoobject.FieldHeaderAttributes:      ObjectAttributeScheme,
